...
\newcommand{\vsetOp}{\OB{\odot}}
\newcommand{\psetOp}{\OB{\underline{\vsetOp}}}

\newcommand{\boldmth}[1]{\textcolor{green(munsell)}{\OB{#1}}}
\newcommand{\pushInBold}[1]{\textcolor{green(munsell)}{\OB{\downarrow}}\left({#1}\right)}

%\newcommand{\filterSet}[1]{\OB{\otimes{#1}}}
\newcommand{\filterSet}[1]{\pushIn {#1}}
...
\newcommand*{\qGroup}[2][\features]{\OB{\qG{\left({#2},{#1}\right)}}}

\newcommand*{\cG}{\OB{\mathcal{C}}}
\newcommand*{\cGroup}[1][\vCond]{\OB{\cG{\left({#1},\features\right)}}}

\newcommand*{\aG}{\OB{\mathcal{A}}}
\newcommand*{\aGroup}[1][\vAttList]{\OB{\aG{\left({#1},\features\right)}}}
...
\newcommand*{\otSemType}[2][\config]{\OB{\otS\sem[#1]{#2}}}
\newcommand*{\otSem}[3][\config]{\OB{\otS\sem[\left({#2}, {#1}\right)]{#3}}}

\newcommand*{\ouS}{\OB{\mathbb{U}}}
\newcommand*{\ouSemType}[2][\config]{\OB{\ouS\sem[#1]{#2}}}
\newcommand*{\ouSem}[3][\config]{\OB{\ouS\sem[\left({#2}, {#1}\right)]{#3}}}
...
\newcommand*{\osetS}{\OB{\mathbb{X}}}
\newcommand*{\osetSem}[2][\config]{\OB{\osetS\sem[#1]{#2}}}

\newcommand*{\xeS}{\OB{\mathbf{x}}}
\newcommand*{\xeSem}[2][\config]{\OB{\xeS\sem[#1]{#2}}}
...
\newcommand{\dropbot}[1]{\OB{\otimes {#1}}}
...
\newcommand{\envCondAnnot}[2][\vctx,{\pushIn{\annot[\VVal{\vctx}]{\vType}}}]
  {\OB{#1\vdash #2}}
...
\newcommand{\domSet}{\OB{\mathit{dom}}}
