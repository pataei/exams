...
\end{alignat*}
\caption[Unique configuration of variational queries]{Unique configuration of variational queries. \cGroup\ and \aGroup\ indicate the grouping of v-conditions and
