...
\synDef v {\mathbf{AttrDom}} &&& \textit{Attribute Value}\\
...
\setDef {\vAtt_1,  \vAtt_2, \ldots,  \vAtt_\numAtts} & \textit{Ordered Set of Attributes}\\
...
\synDef \pSch \pSchSet  &\eqq& \setDef {\pRelSch_1, \pRelSch_2, \ldots, \pRelSch_n} & \textit{Schema}\\
