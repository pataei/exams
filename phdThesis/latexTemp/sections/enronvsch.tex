\subsection{Generating Variational Schema of the Email SPL VDB}
...
%
The resulting variational schema is given in \tabref{enron-vsch}.
...
the variational schema by the new attributes \verificationkey\ and \issigned,
...
%
Additionally, several features require adding entirely new relations.
%
For example, 
...
%
As another example consider the interaction that 
 occurs between the \signature\ and \remailmsg\ features: the \remailmsg\
 ...
 email.
%
Furthermore, consider the interaction that 
...
information needs.
%
We make similar changes made to accommodate all features and their interactions.
% \addressbook, \encryption,
