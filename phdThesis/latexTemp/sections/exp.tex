...
to the approaches used to generate SQL queries introduced in \secref{apps}.
%
...
investigates the effect of the number of (unique) variants on the approaches (\secref{exp-vars}). 
