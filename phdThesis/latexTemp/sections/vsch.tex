...
\eric{sorry about missing the rest of the sentence}
...
that enable \vFive.
\eric{the reason for not using relation notation here is that i don't want to use 
formalization of the variational relation schema, which i'd have to do if i use the
relation notation.}
