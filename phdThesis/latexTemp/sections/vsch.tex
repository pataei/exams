...
\noindent
However, the feature model can be encoded differently. For example, $\VVal {\dimMeta_\mot}$ restricts 
...
Additionally, the encoding of presence conditions can change, since different feature 
expressions can indicate the same set of variants.
