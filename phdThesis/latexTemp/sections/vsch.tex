...
% 
However, this relation cannot capture blah.\wrrite{complete the damn thing}
...
The feature model $\fModel_\mot$ only allows one temporal feature to be true from a set of temporal features at the time. 
\begin{align*}
\fModel_\mot &= 
\left( 
\neg \edu \wedge \left(
...
\noindent
However, the feature model can be encoded differently. For example, $\VVal {\fModel_\mot}$ restrict 
