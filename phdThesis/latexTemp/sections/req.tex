\chapter{Requirements of a Variation-Aware Database Framework}
\label{ch:req}

%In this section, we define the requirements that make a database framework
%variational. 
\rewrite{rewrite based on the change of structure. this is now a new chapter after
you introduce vdb and vq.}
