...
\eric{stop reading here. the rest is copied from vldb.}
To account 
...
%
\rewrite{ref to the prop section.}
...
\eric{I rewrote the following to make sure getting the presence conditions are correct.}
