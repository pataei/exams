...
$.}  
\structure{try to fit the result tables in the same page.}
...
\eric{Eric, pls re-read the following up to section 4.2.2}
...
%
This is done by the $\mathit{genFexp} (\config,\fs)$ that takes a configuration and a closed set of 
