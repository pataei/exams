...
%
The use cases in \secref{db} and \secref{q} show that by treating
...
% databases. However, the understandability of v-queries do seem to be
...
Alternatively, the understandability of v-queries could be improved through
