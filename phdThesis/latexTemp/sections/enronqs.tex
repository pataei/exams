...
One undesirable feature interaction occurs between the two features \signature\ and
\forwardmessages: if Philippe signs a message and sends it to Sarah,
...
%_{\messages.\midatt = \recipientinfo.\midatt}
 \recipientinfo) \\
& \qquad\bowtie_{\sender = \mathit{emp1}.\emailid}
    (\vRen[\mathit{emp1}]{\employees})) \\
& \qquad\bowtie_{\rvalue = \mathit{emp2}.\emailid}
