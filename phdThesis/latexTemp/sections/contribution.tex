...
(adapted from the email SPL described by \citet{Hall05} and explained in \secref{enron-vdb})
...
\chref{rw} (\emph{Related Work}) describes previous research on different kinds of variation 
in databases.

Finally, \chref{conclusion} (\emph{Conclusion}) briefly summarizes the main contributions 
