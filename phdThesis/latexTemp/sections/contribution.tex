...
\chref{vdbusecase} describes the variation scenario for two use cases of VDB, one over space
(adopts the email SPL described by \citet{Hall05}) and another over time (adopts the evolution 
of an employee schema described by \citet{prima08Moon}), in addition to how a VDB can store all database variants in a single database and
