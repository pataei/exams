...
\rewrite{write more details}
\chref{vdb} (\emph{Variational Database Framework}) describes a variational
...
(VDB). Then, \secref{vdbfprop} defines properties of a well-formed VDB.

\wrrite{write this after you finish the chapter.}
\TODO{\chref{vql}}
