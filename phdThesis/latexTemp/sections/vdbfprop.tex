...
\ensuremath{
\forall \config_i, \config_j \in \confSet, i \le j, \odbSem [\config_i] {\vDB} \subseteq \odbSem [\config_j]{\vDB}
}, 
where \ensuremath{\odbSem[\config]{\vDB}} denotes configuring the VDB instance
\vDB\ for configuration \config, defined in \figref{vdb-conf}.
