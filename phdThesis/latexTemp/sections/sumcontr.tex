...
the content and structure levels of databases (\chref{vdb}). 
%
...
%
 ...
 constraints over a database holds (\secref{vdbfprop}).
...
(\secref{vra}) along with its denotational semantics in terms of the relational algebra 
...
database since queries can be explicitly annotated by schemas (\secref{constrain})
