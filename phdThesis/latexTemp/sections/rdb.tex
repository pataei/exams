...
\eric{changed list of values to ordered set and used that to sentence explaining
the correspondence to the order of attributes.}
...
\ericnew{added the new fig \figref{rdb-def}}
\TODO{\figref{rdb-def} defines the relational database objects and type synonyms compactly.}
