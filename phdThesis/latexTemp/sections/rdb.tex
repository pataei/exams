...
\eric{discuss called... it's how db refs define it}
called a relation and has a name, for example, 
...
\eric{well the names are a symbol of attributes. also, i want to stick with attname 
bc it shows that its just a name standing for a concept.}
...
\figref{rdb-def} defines the relational database objects and type synonyms compactly.
