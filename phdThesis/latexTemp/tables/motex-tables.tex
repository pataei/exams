\begin{table}
\caption[Variants of the employee database schema]{Schema variants of the employee database developed for multiple software variants by an SPL. Note that an \educational\ database variant must contain a \basic\ database variant too. 
